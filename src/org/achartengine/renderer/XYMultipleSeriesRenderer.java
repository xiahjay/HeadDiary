...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  /*wwww.javaapk.com 提供测试*/
  private String[] mYTitle;
  /** The axis title text size. 轴标题文本的大小。 */
  private float mAxisTitleTextSize = 12;
  /** The start value in the X axis range. X轴开始值。及X轴最小值*/
  private double[] mMinX;
  /** The end value in the X axis range. X轴结束值。及X轴最大值 */
  private double[] mMaxX;
  /** The start value in the Y axis range. Y轴开始值。及Y轴最小值 */
  private double[] mMinY;
  /** The end value in the Y axis range. Y轴结束值。及Y轴最大值 */
  private double[] mMaxY;
  /** The approximative number of labels on the x axis. 近似的数量的标签在x轴上。(应该就是间隔距离大小)*/
  private int mXLabels = 5;
  /** The approximative number of labels on the y axis. 近似的数量的标签在y轴上。(应该就是间隔距离大小)*/
  private int mYLabels = 5;
  /** The current orientation of the chart. 当前的方向图。(竖直还是横向) */
   ...
   * Returns the start value of the X axis range.
   * 返回开始值X轴的范围。
   * @param scale the renderer scale X轴开始值。及X轴最小值
   * @return the X axis range start value
   */
   ...
   * Returns the end value of the X axis range.
   * 返回开始值X轴的端值范围。
   * @param scale the renderer scale X轴结束值。及X轴最大值
   * @return the X axis range end value
   */
   ...
   * Returns the start value of the Y axis range.
   * 返回开始值Y轴的范围。
   * @param scale the renderer scale Y轴开始值。及Y轴最小值
   * @return the Y axis range end value
   */
   ...
   * Returns the end value of the Y axis range.
   * 返回开始值Y轴的端值范围。
   * @param scale the renderer scale Y轴结束值。及Y轴最大值
   * @return the Y axis range end value
   */
   ...
   * 返回 在X轴或是Y轴上是否可以被缩放，有一个可以则返回true; 父类中也有
   ...
   * 设置平移的限制。{-10, 20, -10, 40} 表示，最左移到-10，最右移到20，最下移到-10，最上移到40 
   */
   ...
   * 返回 缩放的限制。{-10, 20, -10, 40} 表示，最左缩小到-10，最右缩小到20，最下缩小到-10，最上缩小到40
   */
   ...
   * 设置 缩放的限制。{-10, 20, -10, 40} 表示，最左缩小到-10，最右缩小到20，最下缩小到-10，最上缩小到40
   ...
   * 返回 X轴标签的对齐方式。也就是值是在文本的左边、右边还是中间
   ...
   * 返回 Y轴标签的对齐方式。也就是值是在文本的左边、右边还是中间
   * @param scale the renderer scale
